(function() {
  ...
  App.graph = Ember.Object.create({
    ...
    sideBarData: function(index) {
      ...
      org = "<label>"+people[index].organization+"</label>",
      details = "<p>"+people[index].relevance+"</p>";
     $audio = `<audio controls="controls" preload="none">\
                  Your browser does not support the <code>audio</code> element.\
                  
                  <source src="http://da.pantoto.org/stations_audiofiles/carnaticmusic/keerthane/03-sambhO_mahAdEva_shankara-kAmavardani-tyAgarAja.mp3"></audio>`;
      $container.append(name, org, details, $audio); 
